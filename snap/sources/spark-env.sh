...
export SPARK_HOME=${SPARK_HOME:-$SNAP/usr/lib/spark}
export SPARK_LOG_DIR=${SPARK_LOG_DIR:-$SNAP_DATA/var/log/spark}

export HADOOP_HOME=${HADOOP_HOME:-$SNAP/hadoop/usr/lib/hadoop}
...
export HADOOP_CONF_DIR=${HADOOP_CONF_DIR:-$SNAP_DATA/etc/hadoop/conf}
...
export SPARK_WORKER_DIR=${SPARK_WORKER_DIR:-$SNAP_COMMON/var/run/spark/work}
export SPARK_WORKER_PORT=7078
export SPARK_WORKER_WEBUI_PORT=18081
export SPARK_MASTER_URL=spark://$STANDALONE_SPARK_MASTER_HOST:$SPARK_MASTER_PORT
export SPARK_HISTORY_OPTS="$SPARK_HISTORY_OPTS -Dspark.history.fs.logDirectory=file://${SNAP_DATA}/var/log/spark/apps -Dspark.history.ui.port=18082"
